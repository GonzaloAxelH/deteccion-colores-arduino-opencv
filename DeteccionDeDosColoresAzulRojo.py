    ...
    while(count < 20):  
        ...
        for pic, contour in enumerate(contours): 
            ...
            if(area > 300): 
                ...
                colorAzulActivado = True   
                colorGreenActivado = False
                colorRedActivado = False           
            
            
            # verificar por 4 segundos y solo un color , luego enviar el color a aruino
            # y luego parar reconocimiento hasta que el arduino acabe y otra vez 
            #volvemos a detectar en 5 segundos
